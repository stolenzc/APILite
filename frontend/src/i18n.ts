...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'saveRequest.createFolderHint': 'Click “New collection” above, or create one in the collections sidebar.',
    'saveRequest.newCollection': 'New collection',
    ...
    'shortcut.toggleCollectionSidebar': 'Toggle Collections Sidebar',
  ...
  zh: {
    ...
    'saveRequest.createFolderHint': '请点击上方「新建集合」，或在集合侧栏中创建。',
    'saveRequest.newCollection': '新建集合',
    ...
    'shortcut.toggleCollectionSidebar': '切换集合侧栏',
